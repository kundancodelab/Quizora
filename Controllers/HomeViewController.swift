...
class HomeViewController: UIViewController {
    ...
    @IBOutlet weak var textField: UITextField!  // Connect your UITextField
    let defaults = UserDefaults.standard
    private var progressView: CircularProgressView!

    var initialViewPosition: CGFloat = 0  // Store the initial position of the view
    ...
    // Adjust the view's position when keyboard appears
